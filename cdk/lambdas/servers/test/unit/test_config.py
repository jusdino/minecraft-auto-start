...
class TestConfig(BaseTestMAS):
    def test_os_env(self):
        """
        Test that our config object has our expected values pulled from the environment. This really
        tests our BaseTestMAS class as much as anything
        """
        ...
        self.assertEqual('example.org', config.sub_domain)
